...
angular.module('salle').controller('SalleController', [
  ...
  function ($scope) {
    ...
    $scope.slidesCardio = [{ image: '/modules/salle/img/cardio.jpg' }];
    $scope.slidesLibre = [{ image: '/modules/salle/img/libre.jpg' }];
    $scope.slidesGuide = [{ image: '/modules/salle/img/guide.jpg' }];
    $scope.slidesClasses = [
    ...
    $scope.slidesBiking = [{ image: '/modules/salle/img/biking.jpg' }];
    $scope.slidesFreedom = [{ image: '/modules/salle/img/freedom.jpg' }];
    $scope.slidesTrx = [{ image: '/modules/salle/img/trx.jpg' }];
    $scope.slidesRest = [{ image: '/modules/salle/img/rest.jpg' }];
  }
]);'use strict';
